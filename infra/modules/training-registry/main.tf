# ECR repository for training Docker images
...
# Repository policy (optional: add cross-account access if needed)
...
# GitHub OIDC provider for Actions (if not already created)
